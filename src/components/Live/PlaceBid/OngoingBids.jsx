...
function OngoingBids() {
  return (
    <div className="ongoing-bids-container gp-8">
      <div className="summary-container br-4">
        <div className="coloured bid-summary fs-18">
          <span className="fs-18">Ongoing bids</span>
          <span className="fs-18">$30,000</span>
        </div>
        <div className="bid br-4">
          <div>
            <div className="artpiece-amount gp-4">
          ...
          <button className="faded-white br-8 fs-18 withdraw-button">
            Withdraw
          </button>
        </div>
      </div>
